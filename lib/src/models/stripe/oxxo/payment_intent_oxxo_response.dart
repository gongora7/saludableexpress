...
class PaymentIntentOxxoResponse {
    PaymentIntentOxxoResponse({
        this.id,
        this.object,
        this.amount,
    ...
    factory PaymentIntentOxxoResponse.fromJson(String str) => PaymentIntentOxxoResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory PaymentIntentOxxoResponse.fromMap(Map<String, dynamic> json) => PaymentIntentOxxoResponse(
        id: json["id"],
        object: json["object"],
        amount: json["amount"],
